...
export async function POST(request: NextRequest) {
    ...
    const mailOptions: Mail.Options = {
        ...
        <div style='background-color: #020817; color: #ffffff; text-align: center; padding: 10px; border-radius: 10px;'>
            ...
            <span style='font-size: 1.5em;'>Message from ${name} (${email}) on SoFLEX Contact Us page</span>
            ...
            <a href='mailto:${email}' style='color: #0066ff; text-decoration:none'>
                <p style='text-align: left; font-size: 15px; padding: 0px 20px'>
                    ${email}
                </p>
            </a>
            ...
            <p style='color: #666; text-align: center;'>
                This email was sent from the SoFLEX Contact Us page.
            </p>
