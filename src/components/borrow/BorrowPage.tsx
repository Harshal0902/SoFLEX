...
export default function BorrowPage() {
    ...
    return (
        <MaxWidthWrapper>
            ...
            {/* <div className='py-4'>
                <h1 className='text-2xl font-bold lg:text-4xl animate-fade-bottom-up'>Explore Borrowing Options on SoFLEX</h1>
                <p className='pt-4 text-gray-600 sm:text-xl md:pr-16'>Discover flexible borrowing solutions tailored to your needs on SoFLEX. Access peer-to-peer (P2P) borrowing or dive into decentralized finance (DeFi) borrowing for peer-to-pool opportunities. Whether you&apos;re seeking direct lending from peers or exploring DeFi protocols, SoFLEX offers a seamless experience for accessing funds against your compressed NFTs and synthetic assets within the Solana ecosystem.</p>
            </div> */}
