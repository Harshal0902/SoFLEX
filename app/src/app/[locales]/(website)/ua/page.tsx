...
const UserSection: React.FC<UserContentType> = ({ section, content }) => (
    <div className='gap-1'>
...
export default function Page() {
    const t = useTranslations('UAPage');
                ...
                <div className='py-4 w-full'>
                    ...
                    <div className='w-full flex flex-col items-start justify-center space-y-4 px-2 md:px-[5vw]'>
                        {userContent.map((section, index) => (
                            <UserSection key={index} section={section.section} content={section.content} />
                        ))}
                        ...
                        <div className='gap-1'>
                            ...
                            <p className='text-lg'>{t('acceptUA')}</p>
                        </div>
                    </div>
                </div>
            </MaxWidthWrapper>
